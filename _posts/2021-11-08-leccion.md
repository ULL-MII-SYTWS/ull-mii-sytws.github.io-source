...
> If a `.git` directory of a submodule is inside the submodule, move the `.git` directory of the submodule into its superproject’s `$GIT_DIR/modules` path and
...
See also <https://stackoverflow.com/questions/36386667/how-to-make-an-existing-directory-within-a-git-repository-a-git-submodule>
