...
adds the given repository as a submodule at the given path to the *changeset* to be committed next to the current project: the current project is termed the *superproject*.  
